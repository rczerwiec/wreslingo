...
import { FaArrowLeft, FaTools, FaUserLock } from 'react-icons/fa'
      ...
      >
        <div className="flex items-center justify-center mb-8">
          <div className="bg-blue-900/30 p-5 rounded-full">
            <FaUserLock className="text-5xl text-blue-400" />
          </div>
        </div>
        
        <h1 className="text-3xl font-bold text-center mb-2">{t.underConstruction.login.title}</h1>
        ...
        <p className="text-center text-blue-200 mb-8">
          {t.underConstruction.login.message}
        </p>
        
        <div className="text-center">
          <Link
            href="/"
            className="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg transform hover:scale-[1.02] transition-all duration-300 font-medium"
          >
            {t.underConstruction.backToHome}
          </Link>
        </div>
